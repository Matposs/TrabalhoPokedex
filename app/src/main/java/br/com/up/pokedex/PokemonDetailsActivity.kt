...
class PokemonDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var imagemPoke: ImageView = findViewById<View>(R.id.PokeImagem) as ImageView
        ...
        val tiporecyclerView : RecyclerView
                = findViewById(R.id.typeRecycler)

        tiporecyclerView.layoutManager = GridLayoutManager(this, 2)

        val movimentorecyclerView : RecyclerView
                = findViewById(R.id.movesRecycler)

        movimentorecyclerView.layoutManager = GridLayoutManager(this, 3)

        val estatisticarecyclerView : RecyclerView
                = findViewById(R.id.statusRecycler)
        ...
        PokeApi().getPokemonByName(pokemon_name!!){
            ...
            if(pokemon != null){
                ...
                movimentorecyclerView.adapter = MoveAdapter(list_moves)

                var list_stats : List<Stat> = pokemon.stats
                estatisticarecyclerView.adapter = StatsAdapter(list_stats)
